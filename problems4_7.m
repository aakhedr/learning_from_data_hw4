...
fprintf('Option(a)\th(x) = b\t%f\n', E_out_a);
fprintf('Option(b)\th(x) = ax\t%f\n', E_out_b);
...
variance = mean(vars);
E_out_d = bias + variance;
fprintf('Option(d)\th(x) = ax^2\t%f\n', E_out_d);
...
variance = mean(vars);
E_out_e = bias + variance;
fprintf('Option(e)\th(x) = ax^2 + b\t%f\n', E_out_e);
